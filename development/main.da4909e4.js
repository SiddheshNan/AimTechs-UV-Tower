...
},{"core-js/library/fn/parse-int":"../node_modules/core-js/library/fn/parse-int.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var context = null;
var beep_duration = 2000;
var beep_freq = 4500;
document.getElementById("output").addEventListener("change", function toggleCheckbox(element) {
...
document.getElementById("timerSlider").addEventListener("change", function updateSliderTimer() {
  var sliderValue = document.getElementById("timerSlider").value;
  document.getElementById("timerValue").innerHTML = sliderValue + " min";
  timer = (0, _parseInt2.default)(sliderValue) * 1000 * 60;
});
...
function getInitialData() {
  ...
  function clbk(dta) {
    if ((0, _parseInt2.default)(dta.time) > 0) timer = (0, _parseInt2.default)(dta.time);
    pinState = !!(0, _parseInt2.default)(dta.status);
    document.getElementById("timerValue").innerHTML = (0, _parseInt2.default)(timer) / 1000 / 60 + " min";
    document.getElementById("timerSlider").value = (0, _parseInt2.default)(timer) / 1000 / 60;
    document.getElementById("output").checked = pinState;
    if (pinState) document.getElementById("timerSlider").disabled = true;else document.getElementById("timerSlider").disabled = false;

    if (dta.status == "1") {
      var time_left = (0, _parseInt2.default)(dta.time) - (0, _parseInt2.default)(dta.ontime);
      document.getElementById("timeleft").style.visibility = "visible";
...
},{"@babel/runtime-corejs2/core-js/parse-int":"../node_modules/@babel/runtime-corejs2/core-js/parse-int.js","./normalize.min.css":"../src/normalize.min.css","./styles.css":"../src/styles.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
